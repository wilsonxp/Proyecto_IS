...
window.addEvent("domready", function(){
	...
	var campoExp1 = new CampoAutoexplicativo("RFC",{'texto': 'Codigo RFC del Cliente'});
	var campoExp2 = new CampoAutoexplicativo("nom",{'texto': 'Nombre del Cliente'});
	var campoExp3 = new CampoAutoexplicativo("tel",{'texto': 'Teléfono del Cliente'});
	var campoExp4 = new CampoAutoexplicativo("ema",{'texto': 'E-mail del Cliente'});
	var campoExp5 = new CampoAutoexplicativo("dir",{'texto': 'Dirección del Cliente'});
});